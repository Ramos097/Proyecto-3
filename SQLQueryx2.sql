...
('erickmartbre', 'erickmartbre@mail.com', 'Erick', NULL, 'Martinez', NULL, 'Calle Falsa si', '45', 'sinonosi');
...
DROP CONSTRAINT FK__Historial__Usuar__6754599E;
 
ALTER TABLE HistorialUsuarios
ADD CONSTRAINT FK__Historial__Usuar__6754599E
FOREIGN KEY (UsuarioID) REFERENCES Usuarios(UsuarioID)
ON DELETE CASCADE;
...
ALTER TABLE HistorialUsuarios
ADD NombreUsuario NVARCHAR(255) NULL;

--Posibilidad
ALTER TABLE HistorialUsuarios
DROP CONSTRAINT FK_HistorialUsuarios_Usuarios;

ALTER TABLE HistorialUsuarios
ADD CONSTRAINT FK_HistorialUsuarios_Usuarios
FOREIGN KEY (UsuarioID) REFERENCES Usuarios(UsuarioID)
ON DELETE CASCADE;
